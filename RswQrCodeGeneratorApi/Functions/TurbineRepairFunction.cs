...
namespace RswQrCodeGeneratorApi.Functions
{
    ...
    public class TurbineRepairFunction
    {
        const double revenuePerkW = 0.12;
        const double technicianCost = 250;
        const double turbineCost = 100;

        private readonly ILogger<TurbineRepairFunction> _logger;

        public TurbineRepairFunction(ILogger<TurbineRepairFunction> log)
        {
            _logger = log;
        }
